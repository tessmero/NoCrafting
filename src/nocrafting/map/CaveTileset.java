...
public class CaveTileset extends Tileset{
    private static final CaveTileset instance = new CaveTileset();
    public static CaveTileset getInstance(){ return instance; }
    
    public static final int INDEX_FLOOR = 0;
    public static final int INDEX_WALL = 1;
    public static final int INDEX_NE_WALL = 2;
    public static final int INDEX_SE_WALL = 3;
    public static final int INDEX_SW_WALL = 4;
    public static final int INDEX_NW_WALL = 5;
    public static final int INDEX_N_WALL = 6;
    public static final int INDEX_E_WALL = 7;
    public static final int INDEX_S_WALL = 8;
    public static final int INDEX_W_WALL = 9;
    public static final int INDEX_ISLAND = 10;
    public static final int INDEX_SW_BEND = 11;
    public static final int INDEX_NW_BEND = 12;
    public static final int INDEX_NE_BEND = 13;
    public static final int INDEX_SE_BEND = 14;
...
//        { "shoreline_animation",    INDEX_FLOOR,                 INDEX_WALL             },
//    };
...
//        }
    ...
    protected CImage[] buildTiles() {
        System.out.print( "processing cave map tile images..." );
    
        CImage[] result = autoBuildTiles( "cave_tiles", Global.tileSize );
