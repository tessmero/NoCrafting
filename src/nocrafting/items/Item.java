...
//            System.out.println( "private static final CImage icon = new CImage( \"" + result.toVerboseString() + "\" );" );
    ...
    public static class GlowFern extends Item{

        public GlowFern(int xPos, int yPos) {
            super(xPos, yPos);
        }

        @Override
        protected CImage buildSprite() {
            CImage result = new CImage( RawImageHandler.getInstance().getResourceImage( "fern" ) );
        ...
        public void draw( CGraphics g ){
            ...
            g.illuminate( xPos+Global.tileSize/2, yPos+Global.tileSize, 120, 120);
        }
